...
Here is an image showing the links and relationships between BIM, cloud, Revit, node.js and MongoDB and explaining how and where the three FireRatingCloud components fit into the picture:
